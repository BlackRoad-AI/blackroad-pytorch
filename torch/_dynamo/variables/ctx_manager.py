...
class FxTracebackAnnotateBaseVariable(ContextWrappingVariable):
    """
    Base class for fx.traceback annotation context managers (annotate and annotate_fqn).
...
class FxTracebackAnnotateFqnVariable(FxTracebackAnnotateBaseVariable):
    """
    fx.traceback.annotate_fqn is a context manager that allows users to annotate the
    fx graph nodes with fully qualified name metadata.
    """
